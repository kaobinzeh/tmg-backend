...
public sealed class WhenHandlingFifthInvalidCredentialsUserSignInFailed_Should(ContainersFixture fixture)
    : ConsumerWorkerIntegrationTestBase(fixture)
{
    ...
    [Fact]
    public async Task LockAccountAndQueueAccountLockedNotification()
    {
