...
public sealed class WhenHandlingInvalidCredentialsUserSignInFailed_Should
{
    [Fact]
    public async Task IncrementFailedCountWithoutSendingAccountLockedNotification()
    {
